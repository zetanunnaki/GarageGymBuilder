...
const toGenerate = [
  { name: "ultimate-beginners-home-gym-guide", prompt: `A complete beginner home gym with a power rack, loaded barbell, weight plates, adjustable bench, and rubber flooring in a clean industrial garage, dramatic orange accent lighting${baseSuffix}` },
];
