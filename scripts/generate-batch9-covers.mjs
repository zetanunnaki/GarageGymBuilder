...
const toGenerate = [
  { name: "nordic-lifting-knee-sleeves-review", prompt: `A pair of thick black neoprene knee sleeves next to a loaded barbell on a dark rubber gym floor, dramatic orange rim lighting highlighting the sleeve texture${baseSuffix}` },
  { name: "harbinger-lifting-straps-review", prompt: `A pair of padded cotton lifting straps wrapped around a loaded Olympic barbell on a dark rubber gym floor, dramatic orange accent lighting${baseSuffix}` },
  { name: "rip-toned-wrist-wraps-review", prompt: `A pair of black and orange weightlifting wrist wraps with velcro closure on a dark rubber gym floor next to a dumbbell, dramatic orange rim lighting${baseSuffix}` },
  { name: "luxfit-foam-roller-review", prompt: `A long black high-density foam roller on a dark rubber gym floor, dramatic orange rim lighting highlighting the cylinder shape${baseSuffix}` },
  { name: "power-guidance-battle-rope-review", prompt: `A thick heavy battle rope coiled on a dark rubber gym floor with heat shrink handles visible, dramatic orange rim lighting${baseSuffix}` },
  { name: "yes4all-parallettes-review", prompt: `A pair of steel parallette push-up bars on a dark rubber gym floor, dramatic orange rim lighting highlighting the steel frame${baseSuffix}` },
];
