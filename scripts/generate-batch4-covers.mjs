...
const toGenerate = [
  {
    name: "best-rowing-machines",
    prompt: `A magnetic rowing machine with sliding seat, steel frame, and flywheel housing on a dark rubber gym floor, side angle view, dramatic orange accent lighting highlighting the rail and seat${baseSuffix}`,
  },
  {
    name: "best-dip-belts",
    prompt: `A weightlifting dip belt with thick neoprene padding and steel chain hanging from a pull-up bar with a 45 lb cast iron weight plate attached, dark moody background, dramatic orange rim lighting${baseSuffix}`,
  },
  {
    name: "best-plyo-boxes",
    prompt: `A wooden plyometric box made of birch plywood (showing multiple usable heights) on a dark rubber gym floor, dramatic orange rim lighting highlighting the wood grain and edges${baseSuffix}`,
  },
];
