...
For context, I have also used the Rogue Landmine ($45) and the Titan Fitness Landmine ($29). The Rogue is noticeably tighter out of the box and uses a thicker gauge steel, but it costs more than double. The Titan sits in between. For most home gym athletes training with loads under 300 lbs total (barbell plus plates), the Yes4All performs identically to both in actual training. You will not feel a difference mid-set.
