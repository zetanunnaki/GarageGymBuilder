...
<ProsCons data='["Eliminates shoulder and wrist strain entirely","1,500 lb weight capacity — handles any weight","Thick padded yoke is comfortable even at 400+ lbs","Cambered handles are knurled for grip","Fits in any standard power rack with 2\" j-cups","Builds quad and upper back strength better than regular squats"]' type="pros" />
<ProsCons data='["65 lb bar weight — significantly heavier than standard barbell","Takes 2-3 sessions to learn the balance","Padding can make you feel \u0027pushed forward\u0027 at first","Only useful for squat variations and good mornings","Chrome sleeves are adequate, not premium"]' type="cons" />
