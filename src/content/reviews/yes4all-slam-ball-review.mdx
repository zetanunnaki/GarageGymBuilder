...
<VerdictBox productId="yes4all-slam-ball" rating="4.4" verdict="Sand-filled, dead-bounce, and tough enough to survive daily slams on concrete. The PVC shell holds up better than rubber alternatives at this price, and the weight range (10-50 lbs) covers everything from warm-up tosses to brutal conditioning finishers. The seam can eventually split under extreme abuse on rough surfaces — doing slams on a rubber mat extends the life significantly. For the price, it is the right slam ball to start with." />
