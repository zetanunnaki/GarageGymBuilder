...
<VerdictBox productId="yes4all-plyo-box" rating="4.4" verdict="The 3-in-1 design eliminates the need for multiple boxes, and 13-ply birch construction handles athletes well over 200 lbs. The sharp edges are the main drawback — miss a rep and you will scrape your shins badly. Rounding the edges with sandpaper before first use is strongly recommended. At $120 it costs $60-$85 less than Rogue and Titan equivalents, making it the best value in wooden plyo boxes if you respect the landing surface." />
