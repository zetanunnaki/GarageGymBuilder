...
<Faq items={[
  {
    ...
    answer: "Monthly minimum. Weekly in humid environments (Florida, garage gyms in summer). Use a few drops of 3-in-1 oil on a rag and wipe the whole shaft and sleeves. Pay attention to the knurling — moisture lives there."
  },
  {
    question: "Can I clean a rusty barbell?",
    answer: "Yes if the rust is surface-level. Use 3-in-1 oil and a brass brush (not steel — too aggressive). Scrub gently along the grain of the knurling. For deep pitted rust, the bar is permanently damaged but still usable for years."
  },
  {
    question: "How do I tell if my rack needs anchoring?",
    answer: "Push it laterally with both hands. If it moves more than ~1cm with moderate force, it needs to be anchored or weighted. Anchor any rack used for kipping pull-ups, regardless of how stable it feels."
  },
  {
    question: "What's the worst maintenance mistake?",
    answer: "Ignoring small problems. A slightly wobbly J-cup becomes a failing J-cup becomes a dropped bar onto your face. Check things monthly, fix small issues immediately, never assume 'it'll be fine.'"
  },
  {
    question: "Should I cover my equipment when not in use?",
    answer: "Only if your gym is in a humid, uninsulated space (unconditioned garage in a wet climate). Otherwise covers trap moisture against the equipment. Climate-controlled space + monthly oiling beats covers in most cases."
  }
]} />
