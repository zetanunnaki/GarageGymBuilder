...
<Faq items={[
  {
    question: "Do I need a calibrated bar for home powerlifting?",
    answer: "No. A 1500+ PSI Olympic power bar with 28.5mm shaft is more than sufficient for any non-competition training. Calibrated competition bars only matter if you're meet-prepping under sanctioned conditions. Save the $500."
  },
  {
    question: "Cast iron or bumper plates for powerlifting?",
    answer: "Cast iron, every time. Bumpers are thicker, more expensive, and unnecessary for powerlifting where you control the bar from start to finish. Cast iron lets you fit more weight on the bar at heavy attempts."
  },
  {
    question: "How heavy should my power rack rating be?",
    answer: "At least 800 lbs, ideally 1,000+ lbs. The rating includes both the bar load and dynamic forces. A 600 lb rack will flex at 500 lbs of static load. Don't underbuy here."
  },
  {
    question: "Do I need a deadlift platform?",
    answer: "Helpful but not required. A platform protects your floor and keeps the bar from rolling. Two horse stall mats stacked side by side make a perfectly functional platform for under $120. Read our DIY platform guide."
  },
  {
    question: "Can I train for a powerlifting meet at home?",
    answer: "Absolutely. Many regional and national-level powerlifters train exclusively at home and only see a real platform on meet day. The keys are: rigorous attempt selection, regular video review, and finding a meet 8 weeks out to peak for."
  },
  {
    question: "What's the minimum I need to spend?",
    answer: "$1,000 for a complete functional powerlifting setup. The Fitness Reality 810XLT rack ($330), Synergee Games barbell ($200), CAP 300 lb plate set ($340), and FLYBIRD bench ($110) covers everything. Add a belt and sleeves later as you progress."
  }
]} />
