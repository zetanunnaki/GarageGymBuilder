...
<Faq items={[
  {
    question: "What's a fair price for used gym equipment?",
    answer: "Expect 40-60% of retail for equipment in good condition. Iron plates are often priced at $0.50-0.75 per pound (vs $1-1.50 new). Power racks go for 50-70% of retail. Barbells hold value well at 60-80% of retail. Anything under 40% of retail is either a steal or suspicious."
  },
  {
    question: "Is it safe to buy a used barbell?",
    answer: "Yes, if you inspect it properly. Roll it on a flat surface to check for bends, spin the sleeves to verify smooth rotation, and check for deep rust pitting. A barbell from a reputable brand (Rogue, Rep, CAP) that passes these checks is perfectly safe. Avoid no-name bars with unknown weight ratings."
  },
  {
    question: "When is the best time to buy used gym equipment?",
    answer: "February through April — when New Year's resolution buyers give up. You'll find near-new equipment at 40-50% off retail. The second best window is late summer when people move. Avoid buying in December/January when demand peaks."
  },
  {
    question: "Should I buy a used Concept2 rower?",
    answer: "Yes — Concept2 rowers are built to last 30+ years with minimal maintenance. A used RowErg at $700-800 (vs $1,000 new) is one of the best deals in home gym equipment. Check the monitor, chain, and handle for wear, but these machines are nearly indestructible."
  },
  {
    question: "How do I avoid buying stolen gym equipment?",
    answer: "Ask for proof of purchase or the original order email. Check the serial number against the manufacturer's database if possible. Meet in public or at the seller's home (not a random parking lot). Trust your instincts — if the seller is evasive about where the equipment came from, walk away."
  }
]} />
