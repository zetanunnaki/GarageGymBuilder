...
- Budget racks (Fitness Reality, CAP): $100-$200 (retail $250-$400)
...
- Bumper plates (Rogue Echo, Rep, Titan): $0.75-$1.00 per pound (retail $1.25-$1.75/lb)
...
Assault Bikes and Rogue Echo Bikes also hold up exceptionally well on the used market. Air resistance mechanisms have no electronics to fail — the harder you pedal, the more resistance you get. Check the chain (or belt) tension, seat adjustment mechanism, and pedal threads.
...
Equipment with no identifiable manufacturer, no model number, and no published weight capacity specs should be avoided used (and arguably new as well). Without knowing the steel gauge, weld quality, and load ratings, you are trusting your safety to a complete unknown. Brand-name equipment from Rogue, Rep Fitness, Titan, Bells of Steel, Kabuki, or even budget brands like CAP and Fitness Reality at least has published specifications and replacement parts available.
