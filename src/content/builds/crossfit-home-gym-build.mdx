...
The pull-up bar also serves as the anchor point for gymnastic rings (item 5 below), giving you ring muscle-ups, ring dips, and ring rows without any additional mounting hardware. Read our [full review](/reviews/fitness-reality-810xlt-review/).
...
### 5. Gymnastic Rings — Yes4All Wood Rings ($40)

<ProductCard productId="rogue-style-gymnastic-rings" badge="Muscle-Ups" />

Gymnastic rings unlock three movements you cannot replicate with any other equipment: ring muscle-ups, ring dips, and false grip ring rows. These are staple CrossFit movements that appear in benchmark WODs (like the CrossFit Games Open) and daily programming. The Yes4All Wood Gymnastic Rings use solid birch wood — the same material as competition-grade Rogue rings — with an 880 lb weight rating and numbered straps for quick height adjustment.
...
### 7. Wooden Plyo Box — Yes4All 3-in-1 ($120)
...
Use it for loaded carries in conditioning workouts: farmers walks, suitcase carries, and trap bar marches build grip strength and trunk stability that transfer directly to barbell cycling endurance. Read our [full review](/reviews/yes4all-hex-trap-bar-review/).
...
**Running Total: $1,665** — that leaves $335 under the $2,000 budget for upgrades.
...
**Month 2 — Gymnastics and Conditioning ($175)**
- Gymnastic rings ($40)
- Speed jump rope ($15)
- Plyo box ($120)
...
**Month 3 — Variety and Accessories ($620)**
- Kettlebells ($150)
- Slam ball ($30)
...
That progression takes the gym from $1,665 to approximately $3,400-3,700, covering every movement that appears in CrossFit programming including competition-level Open workouts. For a complete high-end build, see our [dream gym under $5,000](/builds/dream-gym-under-5000/) guide.
