...
Position the Mikolo F4 power rack against the back wall, centered, with 3 feet of clearance in front for deadlifts and barbell rows. The bench slides in and out of the rack for pressing. Place the Assault AirBike against the left wall — it does not need proximity to the rack and benefits from being near a fan or garage door for airflow. The Bowflex SelectTech dumbbells sit on their included tray against the right wall, with 6 feet of open floor in front for lunges, flyes, and single-arm work. Kettlebells line up along the wall near the dumbbells.
...
The Mikolo F4 2.0 is the foundation of this build and the single most important purchase you will make. At $489, it delivers a full power rack plus an integrated LAT pulldown and low row cable system — a combination that would cost $700-900 if purchased separately as a rack plus standalone cable station.
...
Read our [Mikolo F4 review](/reviews/mikolo-f4-power-cage-review/) or the [Mikolo vs Fitness Reality comparison](/best-gear/mikolo-f4-vs-fitness-reality-810xlt/) for detailed testing notes.
...
The Assault Bike is slightly louder than the Rogue Echo Bike due to its chain drive (the Echo uses a belt), but it costs $250 less and performs identically for training purposes. If noise is a concern — apartments, shared walls, sleeping family members — read our [Assault AirBike review](/reviews/assault-airbike-review/) and the [Concept2 vs Assault comparison](/best-gear/concept2-vs-assault-bike/) for noise level comparisons.
...
Mikolo F4 Power Rack ($489), FLYBIRD Bench ($110), CAP 300 lb Barbell Set ($340). This gives you a complete barbell training setup on day one. You can run any strength program — Starting Strength, 5/3/1, GGRP, nSuns — with just these three items.

**Month 2 — Conditioning and Isolation ($1,178):**
Assault AirBike ($749), Bowflex SelectTech 552 ($429). The air bike adds conditioning capability, and the dumbbells open up accessory work that accelerates hypertrophy and addresses weak points.
...
Assault Bike intervals, kettlebell swings, barbell thrusters, pull-ups on the rack, and dumbbell movements combine into any WOD-style workout. You lack a rower and a GHD machine, but those are the only significant omissions.
...
- Spray the Assault AirBike chain with a light lubricant every 50 hours of use
...
- Replace Assault AirBike chain if it shows stretch or rust (roughly $25 part)
...
1. **REP AB-5200 Adjustable Bench ($549):** Zero-gap design, denser pad, and wheel transport system. The single best quality-of-life upgrade for anyone who bench presses frequently.
