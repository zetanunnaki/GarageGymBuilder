  ...
  return {
    ...
    openGraph: {
      ...
      images: frontmatter.featuredImage
        ...
        : [{ url: "/og/guide.png", width: 1200, height: 630, alt: frontmatter.title, type: "image/png" }],
    },
    twitter: {
      ...
      images: frontmatter.featuredImage ? [frontmatter.featuredImage] : ["/og/guide.png"],
    },
  };
}
      ...
      <header className="mb-12">
        <div className="mb-4 flex items-center gap-3">
          <span className="text-[10px] font-black uppercase tracking-widest text-orange-500">
            Guide &middot; {frontmatter.category}
          </span>
